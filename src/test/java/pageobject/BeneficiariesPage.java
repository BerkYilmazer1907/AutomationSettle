...
public class BeneficiariesPage extends DriverFact {
    ...
    public void SettingsPage(String currency, String bankCountry) {
    ...
    public void BeneficiaryPage(String currency, String bankCountry, String benCountry) throws InterruptedException {
        sleep(2);
    ...
    public void BankDetailsCtsDhb(String currency, String payment, String bankCountry, String benCountry) throws InterruptedException {
        if (currency.contains("British") && bankCountry.contains("United Kingdom")) {
            sleep(2);
            ...
            driver.findElement(By.xpath(IbanXpath)).sendKeys("GB89BARC20320023233545");
            driver.findElement(By.xpath(BICSWIFTXpath)).sendKeys("BKENGB2L");
        } else if (currency.contains("Euro") && bankCountry.contains("Malta")) {
            sleep(2);
            waitPresence(By.xpath(AccountHolderNameXpath));
            driver.findElement(By.xpath(AccountHolderNameXpath)).sendKeys("TestMalta");
        ...
        } else if (currency.contains("Euro") && bankCountry.contains("Norway")) {
            sleep(2);
            waitPresence(By.xpath(AccountHolderNameXpath));
            driver.findElement(By.xpath(AccountHolderNameXpath)).sendKeys("TestNorway");
            driver.findElement(By.xpath(IbanXpath)).sendKeys("NO9386011117947");
            driver.findElement(By.xpath(BICSWIFTXpath)).sendKeys("DNAMNOKK");
        } else if (currency.contains("Euro") && bankCountry.contains("Cyprus")) {
            sleep(2);
            waitPresence(By.xpath(AccountHolderNameXpath));
            driver.findElement(By.xpath(AccountHolderNameXpath)).sendKeys("TestCyprus");
            driver.findElement(By.xpath(IbanXpath)).sendKeys("CY17002001280000001200527600");
            driver.findElement(By.xpath(BICSWIFTXpath)).sendKeys("LATCCY2L");
    ...
    public void BeneficiaryDelete() throws InterruptedException {
        sleep(1);
        waitPresence(By.className("beneficiaries"));
        driver.findElement(By.className("beneficiaries")).click();
        sleep(3);
        driver.findElement(By.xpath("//*[@class='option-link remove']")).click();
        sleep(1);
        driver.findElement(By.xpath("//*[@class='btn-style centered w250']")).click();
        sleep(1);
    }

    public void CheckIfBeneficiaryDelete() {
        String Message = driver.findElement(By.xpath("//*[@class='trns-item']")).getText();
        assertEquals(Message, "No beneficiary found");
    }
    ...
    public void BankDetailsPageMnx(String currency, String bankCountry) throws InterruptedException {
        if (currency.contains("British") && bankCountry.contains("United Kingdom")) {
            sleep(2);
            waitPresence(By.xpath(AccountHolderNameXpath));
            driver.findElement(By.xpath(AccountHolderNameXpath)).sendKeys("Test1234");
            ...
            driver.findElement(By.xpath(IbanXpath)).sendKeys("GB89BARC20320023233545");
            driver.findElement(By.xpath(BICSWIFTXpath)).sendKeys("ANTSGB2L");
        } else if (currency.contains("Euro") && bankCountry.contains("Germany")) {
            sleep(2);
            driver.findElement(By.xpath(AccountHolderNameXpath)).sendKeys("Test1234");
            driver.findElement(By.xpath(IbanXpath)).sendKeys("DE89370400440532013000");
            driver.findElement(By.xpath(BICSWIFTXpath)).sendKeys("AARBDE5W100");
            ...
            driver.findElement(By.xpath(IbanXpath)).sendKeys("NO8330001234567");
            driver.findElement(By.xpath(BICSWIFTXpath)).sendKeys("CITINOKXXXX");
        } else if (currency.contains("Euro") && bankCountry.contains("Belgium")) {
            sleep(2);
            waitPresence(By.xpath(AccountHolderNameXpath));
            driver.findElement(By.xpath(AccountHolderNameXpath)).sendKeys("TestBelgium");
            driver.findElement(By.xpath(IbanXpath)).sendKeys("BE68539007547034");
            ...
            driver.findElement(By.xpath(AccountHolderNameXpath)).sendKeys("TestNorway");
            driver.findElement(By.xpath(BICSWIFTXpath)).sendKeys("DNAMNOKK");
            driver.findElement(By.xpath("//*[@placeholder='Account Number']")).sendKeys("1117947");
