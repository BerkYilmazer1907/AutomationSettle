...
public class ConversionPage extends DriverFact {
    ...
    public void ConversionPagee(String sellCurrency, String buyCurrency, String AmountTo) throws InterruptedException {
        sleep(2);
...
//            driver.findElement(By.id("conversionamount")).sendKeys("1000");
    ...
    public void CheckIfConversionSucessfull() throws InterruptedException {

        Thread.sleep(5000);
        String successMessage = driver.findElement(By.xpath("//*[text()='Congratulations! Conversion of']")).getText();
        assertEquals("Congratulations! Conversion of", successMessage);
    }
